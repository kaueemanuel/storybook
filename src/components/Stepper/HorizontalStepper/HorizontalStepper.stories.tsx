...
import { HorizontalStepper as HorizontalStepperComponent } from "./HorizontalStepper"
...
const meta = {
  title: "Components/Navigation/Stepper/HorizontalStepper",
  component: HorizontalStepperComponent,
  render: (args) => (
    <HorizontalStepperComponent key={JSON.stringify(args)} {...args} />
  ),
  decorators: [
    (Story) => (
...
} satisfies Meta<typeof HorizontalStepperComponent>
